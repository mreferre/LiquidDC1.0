...
vmware.cloud = function(base, version) {
    ...
    that.login = function(username, password, organization) {
        ...
        console.log("LoginUrl: "+loginUrl, url);
...
vmware.rest = (function() {
    ...
    var createAjaxRequest = function(type, url, dtype) {
        console.log("Ajax",type,url,dtype);
        return $.ajax(url, {
            type: type,
            headers: headers,
    ...
    console.log("GET:"+url);
    console.log(createAjaxRequest("GET", url));
